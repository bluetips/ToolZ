...
class Mysql(object):
    ...
    def __init__(self, Config, charset='utf8'):
        ...
        self.Config = Config
        DBHOST, DBPORT, DBUSER, DBPWD, DBNAME = self.Config['host'], self.Config['port'], self.Config['user'], \
                                                self.Config['password'], self.Config['db']
        # self.charset = charset
        while 1:
            try:
                self._conn = Mysql.__getConn(DBHOST, DBPORT, DBUSER, DBPWD, DBNAME, charset=charset)
                break
            except:
                pass
    ...
    @staticmethod
    def __getConn(DBHOST, DBPORT, DBUSER, DBPWD, DBNAME, charset='utf8'):
        """
        ...
        if Mysql.__pool is None:
            __pool = PooledDB(creator=pymysql, mincached=1, maxcached=20,
                              ...
                              db=DBNAME, use_unicode=False, charset=charset, cursorclass=DictCursor)
